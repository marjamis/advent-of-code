...
import (
	...
	"github.com/marjamis/advent-of-code/internal/pkg/advent2021"
...
var days2021 = map[string]day{
	...
	"09": {
		Function: func() {
			...
			fmt.Println(advent2021.Day9Part2(input))
		}},
	"10": {
		Function: func() {
	...
	"11": {
		Function: func() {
			input := helpers.ReadIntArray2d(dataDirectory2021 + "day11.txt")
			fmt.Println(advent2021.Day11Part1(input))
			fmt.Println(advent2021.Day11Part2(input))
		}},
	"12": {
		Function: func() {
			input := helpers.ReadStringArray(dataDirectory2021 + "day12.txt")
			fmt.Println(advent2021.Day12Part1(input))
			fmt.Println(advent2021.Day12Part2(input))
		}},
	"13": {
		Function: func() {
			input := helpers.ReadStringArray(dataDirectory2021 + "day13.txt")
			fmt.Printf("Part 1 - Simulated solution: %d\n", advent2021.Day13Part1Simulated(input))
			fmt.Printf("Part 1 - Calculated solution: %d\n", advent2021.Day13Part1Calculated(input))
			// fmt.Printf("Part 2 - Simulated solution:\n%s\n", advent2021.Day13Part2Simulated(input))
			fmt.Printf("Part 2 - Calculated solution:\n%s\n", advent2021.Day13Part2Calculated(input))
		}},
}
